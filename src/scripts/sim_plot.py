...
def psi_dist_draws(model_name):
    ...
    istar_idata = az.from_netcdf(paths.data / "simulation/%s_istar.nc"%str(model_name))
    noistar_idata = az.from_netcdf(paths.data / "simulation/%s_noistar.nc"%str(model_name))
