...
Stellar obliquity $\psi$, the angle between a planet's orbital axis and its host star's spin axis, has important implications for the formation environment and evolution of a planetary system. In exoplanet observations, only sky-projected stellar obliquity $\lambda$ can be measured. To find the stellar obliquity, information on the stellar inclination $i_\star$ is required.
Here we show that, while it is important to measure the stellar inclination to tightly constrain the stellar obliquity of an individual system, stellar inclination is not necessarily required to infer the population stellar obliquity distribution. The stellar obliquity distribution can be inferred purely from the projected stellar obliquities, or even from the stellar inclinations.
We introduce a flexible, hierarchical Bayesian framework to infer stellar obliquity distribution of exoplanetary systems that can be applied to a sample with measured projected stellar obliquities, stellar inclinations, or both.
We apply the framework to all systems with measured projected stellar obliquities, which are mostly hot Jupiters, and find that the stellar obliquity distribution is unimodal and peaked at zero degrees. Misaligned systems have nearly isotropic stellar obliquity distribution. When compared to hot Jupiter stellar obliquity predictions, the distribution is most consistent with the outcome of the scattering of multiple giant planets after their convergent disk migration.
