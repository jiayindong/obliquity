...
Here we show that, while it is important to know the stellar inclination to tightly constrain the stellar obliquity of an individual system, the stellar inclination is not necessarily required for the population stellar obliquity inference. Stellar obliquity distribution can be inferred purely from sky-projected stellar obliquities.
We introduce a flexible, hierarchical Bayesian framework to infer the stellar obliquity distribution of exoplanetary systems from their projected stellar obliquities, stellar inclinations, or both.
