...
Our analysis suggests misaligned systems have nearly isotropic stellar obliquity distribution. When comparing the inferred distribution with the prediction of stellar obliquity distributions in different Hot Jupiter origin scenarios, it is in best agreement with the outcome of the scattering of multiple giant planets after a convergent disk migration \citep[e.g.,][]{Beague12}, which could produce planets with orbital inclination from $0\degr$ to $180\degr$ with a peak at $0\degr$. This interesting result can be further tested on more carefully selected Hot Jupiter samples and put constraints on Hot Jupiter origins.
