...
In this section, we find the expression of $\lambda$ and $i_\star$ in terms of $\psi$, $\theta$, and $i_{\rm orb}$. To do so, we introduce two coordinates that describe the stellar spin axis and its planet's orbital axis.
