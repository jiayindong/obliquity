...
Furthermore, misaligned Hot Jupiters have a diverse range of stellar obliquities from $0\degr$ to $180\degr$, preferring dynamic mechanisms, such as planet-planet scattering after a convergent disk migration or planetary Kozai, which could produce broad distributions.}
...
\begin{figure*}[ht!]
    \centering
    \script{transform.py}
    \includegraphics[width=0.8\linewidth]{figures/transform.pdf}
