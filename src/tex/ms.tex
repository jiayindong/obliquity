...
When applying the framework to all exoplanetary systems with measured sky-projected stellar obliquity, we find that the inferred population-level obliquity distribution is unimodal and peaked at zero degrees \edits{with a fraction of $72\pm9$\,\%. The $28\pm9$\,\% fraction of misaligned systems has nearly isotropic stellar obliquities with no strong clustering near 90$\degr$.
